...
public class PhotoFun extends AppCompatActivity {
    ...
    */
    ...
    private class brightnessSeekBarListener
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser){
            ...
            Log.i("Delta", ""+SeekBarState.getInstance().getBrightnessDelta());
            TextView brightnessAdjust = (TextView) findViewById(R.id.brightnessText);
            filter.setAdjustment(progress);
            brightnessAdjust.setText("Brightness Adjustment:  "+ filter.getAdjustment());
